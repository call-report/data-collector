...
from ffiec_data_collector.downloader import (
    FFIECDownloader, Product, FileFormat, ReportingPeriod, 
...
class TestFFIECDownloader:
    ...
    def test_extract_last_updated_dates(self):
        ...
        call_updated, ubpr_updated = self.downloader._extract_last_updated_dates(html_content)
    ...
    def test_get_last_updated_for_product(self):
        ...
        # Test UBPR product
        ubpr_date = self.downloader._get_last_updated_for_product(Product.UBPR_RATIO_SINGLE)
...
class TestProductEnum:
    ...
    def test_product_values(self):
        ...
        assert call_single.value == "ReportingSeriesSinglePeriod"
